...
/*     this.customer = combineLatest([
    ...
    // comment out previous customer stream definition and re-define it here with the help of
    // combineLatest (RxJs creation operator) to combine previously used "paramMap" stream
